...
class ContentSeeder extends Seeder
{
    ...
    private function seedCmsContentStringTable()
    {
        $cmsStrings = [
            ...
            ['content_id' => 3, 'value' => 'common/paragraph',],
